---
title: Bloque 3.3 — Edición de STEPs importados (La joya de NX)
description: Lección práctica de siemens-nx.
sidebar:
  order: 3
---
## 📺 Clase en Video
...
## 📝 Resumen
Contenido pendiente para **Edición de STEPs importados (La joya de NX)**.
